...
public class ClientToSaveEntity {
    ...
    private String name;
    private String type;
    private Float currentCreditUsed;
    ...
    public Float getCurrentCreditUsed() {
        return currentCreditUsed;
    }

    public void setCurrentCreditUsed(Float currentCreditUsed) {
        this.currentCreditUsed = currentCreditUsed;
    }
